...
export function openHub(ctx, { onVenture }) {
  ...
  s.append(el('div.hub-wrap', {}, [
    ...
    el('p.hub-story', {}, '“Seek out those who still stand against the Hand — a scout, a hedge-witch, a penitent. You will not face the wood alone.”'),
    el('p.hub-hero', {}, [iconEl(c.id), ` You are a ${r.name} ${c.name}.`]),
    el('nav.menu', {}, [
